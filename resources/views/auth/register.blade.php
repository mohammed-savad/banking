      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-outline mb-4">
              <label class="form-label" for="typeEmailX-2"> <strong>Name</strong> </label>
              <input type="text" id="name" class="form-control form-control-lg" placeholder="Enter Name" name="name" :value="old('name')" required autofocus autocomplete="name"  />
            </div>

            <div class="form-outline mb-4">
              <label class="form-label" for="typeEmailX-2"> <strong>Email address</strong> </label>
              <input type="email" id="email" class="form-control form-control-lg" name="email" placeholder="Enter Email" :value="old('email')" required autocomplete="username"  />
            </div>
            ...
            <div class="form-outline mb-4">
              <label class="form-label" for="typePasswordX-2"> <strong>Confirm Password</strong> </label>
            ...
            <!-- <div class="form-check d-flex justify-content-start mb-4">
              ...
              <label class="form-check-label" for="form1Example3"><strong>Remember password</strong> </label>
            </div> -->
        ...
        <center><strong><P>Allready have an account? <a href="{{route('login')}}">Sign in</a></P></strong></center>
  </div>
</section>
