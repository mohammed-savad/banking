      ...
      <div class="col-12 col-md-8 col-lg-6 col-xl-5">
        <div class="card shadow-2-strong" style="border-radius: 1rem;">
          <div class="card-body p-5 ">
                ...
                <form method="POST" action="{{ route('deposit_store') }}">
                    @csrf
                    <h3 class="mb-5">Deposit Money</h3>

                    <div class="form-outline mb-4">
                    <label class="form-label" for="typeEmailX-2"> <strong>Amount</strong> </label>
                    <input type="number" id="deposit" class="form-control form-control-lg" placeholder="Amount" name="deposit" :value="old('deposit')" required />
                    </div>
